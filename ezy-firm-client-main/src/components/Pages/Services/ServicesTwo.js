...
const ServicesTwo = () => {
  return (
    <Layout title={"Services - Ezy Farming"}>
      <div className="my-10">
              ...
              <div class="p-4 md:w-1/3">
                <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                  ...
                  <div class="p-6">
                    ...
                    <p class="leading-relaxed mb-3 service-paragraph">
                      Defend your crops with our Pest and Disease Control
                      service. We employ cutting-edge techniques to identify,
                      manage, and prevent the impact of pests and diseases on
                      your agricultural yield. Our experts provide strategic
                      solutions, incorporating both organic and sustainable
                      practices.
                    </p>
                    <div class="flex items-center flex-wrap ">
                      <Link
